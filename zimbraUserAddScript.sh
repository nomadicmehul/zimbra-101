...
#
# ------------------------------------------------------------------------------
# Descriptions : This script takes a csv file, called '/tmp/newusers.csv', and converts it as an input
...
# Example:
# "mehul.patel@example.com";"Mehul Patel";"Acme Inc";"This guy works in engineering";996323418;4216857841;"Valley road, random colony";"Ahmedabad";"India"
# 
